...
<body>
 ...
 <div class="wrapper">
            <div class ="logo">
    <center><h2 style="color:white;">ONLINE VOTING SYTEM</h2></center>
...
<tr>
        ...
        <p style="color:red"><?php //secho $errors['password'];?></p>
      </tr>
        <tr>
<div class="cancalbtn">
        ...
        <td><button type="submit"class="button submit" name="submit"><a href="register.php">Sign Up </a></button></td>
      </div>
      </tr>
     <tr>
