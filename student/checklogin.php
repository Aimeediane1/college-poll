...
$sql=mysqli_query($connection, "SELECT * FROM user WHERE email='$myusername' and password='$encrypted_mypassword'");
...
echo "Wrong Username or Password<br><br>Return to <a href=\"login3.php\">login</a>";
}
